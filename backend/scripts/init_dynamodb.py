...
def create_table_if_not_exists(
    dynamodb_resource, table_name, key_schema, attribute_definitions
):
...
def test_dynamodb():
    ...
    try:
        create_table_if_not_exists(
            dynamodb_resource,
            agent_config_table,
            key_schema=[{"AttributeName": "config_id", "KeyType": "HASH"}],
    ...
    try:
        create_table_if_not_exists(
            dynamodb_resource,
            prompts_table,
            key_schema=[{"AttributeName": "prompt_id", "KeyType": "HASH"}],
            attribute_definitions=[
    ...
    try:
        create_table_if_not_exists(
            dynamodb_resource,
            execution_table,
            key_schema=[{"AttributeName": "execution_id", "KeyType": "HASH"}],
            attribute_definitions=[
